...
void JOY_setButtons(uint8_t buttons);       // set joystick buttons (direct assignment)
void JOY_press(uint8_t buttons);            // press joystick button(s) [deprecated]
void JOY_release(uint8_t buttons);          // release joystick button(s) [deprecated]
void JOY_move(int8_t xrel, int8_t yrel);    // move joystick
void JOY_send(void);                        // send joystick report
